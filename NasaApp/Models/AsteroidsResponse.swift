...
//  NasaApp
//
//  Created by Felipe Almeida on 07/12/20.
//

import Foundation

// MARK: - AsteroidsResponse
struct AsteroidsResponse: Codable {
    let links: AsteroidsResponseLinks?
...
// MARK: - AsteroidsResponseLinks
struct AsteroidsResponseLinks: Codable {
